...
plt.vlines(0.265, -0.5, 6,colors='r',linestyles='--',label="T=0.28",linewidth=0.5)#, kwargs)
plt.ylim((-0.4,5.9))#, kwargs)
plt.title("Critical Point of Preference Model")#, kwargs)
plt.xlabel("Temperature")
